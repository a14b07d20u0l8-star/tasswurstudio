...
export const MODULES: Record<ModuleKey, ModuleConfig> = {
  dfunctions: {
    ...
    plans: [
      { id: "7d", label: "1500 PKR / 7 days", price: 1500, days: 7 },
      { id: "30d", label: "5300 PKR / 30 days", price: 5300, days: 30 },
    ],
  ...
  worker: {
    ...
    plans: [
      { id: "7d", label: "800 PKR / 7 days", price: 800, days: 7 },
      { id: "30d", label: "4500 PKR / 30 days", price: 4500, days: 30 },
    ],
  ...
  hall: {
    ...
    plans: [
      { id: "7d", label: "2000 PKR / 7 days", price: 2000, days: 7 },
      { id: "30d", label: "8000 PKR / 30 days", price: 8000, days: 30 },
    ],
