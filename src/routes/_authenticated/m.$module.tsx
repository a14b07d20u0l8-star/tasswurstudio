...
export const CategoryRoute = createFileRoute("/_authenticated/m/$module/$category")({
...
function CategoryPage() {
  const { module, category } = Route.useParams() as any;
  const key = module as ModuleKey;
  const cfg = MODULES[key];
...
function ListingCard({ item, cfg, delay }: { item: Listing; cfg: any; delay: number }) {
